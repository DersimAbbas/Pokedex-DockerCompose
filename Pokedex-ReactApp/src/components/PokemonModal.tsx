...
const typeGradients: Record<string, string> = {
  ...
  dark: 'linear-gradient(135deg, #bdbdbd 60%, #757575 100%)',
  rock: 'linear-gradient(135deg, #cfd8dc 60%, #b0bec5 100%)',
  ghost: 'linear-gradient(135deg, #e0e0e0 60%, #bdbdbd 100%)',
  normal: 'linear-gradient(135deg, #f5f5f5 60%, #eeeeee 100%)',
